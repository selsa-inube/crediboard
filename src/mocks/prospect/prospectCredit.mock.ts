...
export const mockProspectCredit: IProspect[] = [
  {
    ...
    credit_product: [
      ...
      {
        abbreviated_name: "Vehículo Nuevo",
        credit_product_code: "888880",
        loan_amount: 30000000,
        line_of_credit_code: "200",
        line_of_credit_abbreviated_name: "Compra Vehículo",
        interest_rate: 1.2,
        fixed_points: 6,
        loan_term: 24,
        ...
        ordinary_installment_for_principal: {
          ...
          schedule: Schedule.Monthly,
          installment_amount_for_capital: 1000000,
          installment_amount: 50000,
          gradient_rate: 9,
          gradient_value: 2000000,
          gradient_schedule: "quarterly",
          first_gradient_date: "2024-03-01T23:59:59Z",
          payment_channel_code: "TRANSFER",
        },
        ordinary_installment_for_interest: {
          schedule: Schedule.Monthly,
        ...
        extraordinary_installment: {
          ...
          installment_date: "2024-02-01T23:59:59Z",
          payment_channel_code: "CAJA",
        },
        acquired_cash_flow: {
          amount: "1000",
          date: "2024-02-01T23:59:59Z",
          payment_channel_unique_code: "Vehículo",
          flow_number: 5,
        },
      },
      {
        abbreviated_name: "Educación Superior",
        credit_product_code: "777770",
        loan_amount: 15000000,
        line_of_credit_code: "300",
        line_of_credit_abbreviated_name: "Financiación Estudiantil",
        interest_rate: 0.9,
        fixed_points: 4,
        loan_term: 36,
        schedule: Schedule.Monthly,
        ordinary_installment_for_principal: {
          ...
          schedule: Schedule.Monthly,
          installment_amount_for_capital: 500000,
          installment_amount: 20000,
          gradient_rate: 7,
          gradient_value: 500000,
          gradient_schedule: "semi-annual",
          first_gradient_date: "2024-06-01T23:59:59Z",
          payment_channel_code: "TRANSFER",
        },
        ordinary_installment_for_interest: {
          schedule: Schedule.Monthly,
        ...
        extraordinary_installment: {
          ...
          installment_date: "2024-05-01T23:59:59Z",
          payment_channel_code: "CAJA",
        },
        acquired_cash_flow: {
          amount: "500",
          date: "2024-05-01T23:59:59Z",
          payment_channel_unique_code: "Educación",
          flow_number: 3,
        },
      },
    ],
