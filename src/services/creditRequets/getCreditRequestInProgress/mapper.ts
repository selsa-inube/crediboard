...
export const mapCreditRequestToEntity = (data: Record<string, string | number | object>): Requests => {
    const creditRequest: Requests = {
        ...
        moneyDestinationAbreviatedName: data.moneyDestinationAbreviatedName as string,
