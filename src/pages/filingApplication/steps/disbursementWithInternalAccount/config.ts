export const disbursementln = [
    { id: "internalAccount", disabled: false, label: "Cuenta interna" },
    { id: "externalAccount", disabled: false, label: "Cuenta externa" },
    { id: "entityCheck", disabled: false, label: "Cheque entidad" },
    { id: "managementCheck", disabled: false, label: "Cheque de gerencia" },
